...
class JSONFileDataLoader(FileDataLoader):
    ...
    def next_one_tf(self, N, K, Q):
        ...
        support_set['pos1'] = np.concatenate(support_set['pos1'], 0)
        support_set['pos2'] = np.concatenate(support_set['pos2'], 0)
        ...
        inputs.setdefault("pos1", np.concatenate([support_set['pos1'], query_set['pos1']]))
        inputs.setdefault("pos2", np.concatenate([support_set['pos2'], query_set['pos2']]))
